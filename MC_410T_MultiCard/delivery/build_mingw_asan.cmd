...
"%CMAKE_EXE%" --preset mingw-asan -DRING_RECON_CUDA_IMPORT_LIB=%CUDA_BLD%\libring_recon_cuda.dll.a -DRING_RECON_CUDA_BIN=%CUDA_BLD%\bin
if errorlevel 1 exit /b %errorlevel%
"%CMAKE_EXE%" --build --preset mingw-asan-build
exit /b %errorlevel%
