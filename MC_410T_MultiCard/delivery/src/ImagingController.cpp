...
void ImagingController::sendConfigureAndStart()
{
    ...
    if (m_ringMode) {
        ...
        ring["coherenceGate"]   = m_ringConfig.coherenceGate;
        ring["coherenceGain"]   = m_ringConfig.coherenceGain;
        ring["coherenceEpsilon"] = m_ringConfig.coherenceEpsilon;
        ring["nonlinearMode"]   = m_ringConfig.nonlinearMode;
        QJsonArray radiusCh;
        for (int i = 0; i < 8; ++i)
