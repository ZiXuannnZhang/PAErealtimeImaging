...
ROOT=Path(__file__).resolve().parent;SOURCE=ROOT.parents[2]/'CODEX_REPORTS/reliable-binary-analysis-20260909';sys.path.insert(0,str(SOURCE/'tools'))
import pefile,capstone
pe=pefile.PE(str(SOURCE/'resources/10-101-1033.bin'));idx=json.loads((ROOT/'binary-index.json').read_text());base=pe.OPTIONAL_HEADER.ImageBase
